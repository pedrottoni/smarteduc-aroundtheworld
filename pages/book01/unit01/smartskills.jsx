    ...
    <>
      <BookPage title="smart skills" title2="You are amazing!" image="">
        <div className="content svg ">
          <Puzzle name="step1" image="book01/unit01/ss_step1" col="IIIcol" shadow={Colors.smartYellowDark} width="186" height="150" />
          <Puzzle name="step2" image="book01/unit01/ss_step2" col="IIIcol" shadow={Colors.smartYellowDark} width="186" height="150" />
          <Puzzle name="step3" image="book01/unit01/ss_step3" col="IIIcol" shadow={Colors.smartYellowDark} width="186" height="150" />
        </div>
