  ...
  return (
    <>
      ...
      <Accordion title="North america collection" color={Colors.smartPurple} textColor={Colors.smartYellow}>
        ...
        <Accordion title="unit 02 - Getting ready to travel aboard" className={true} textColor={Colors.smartPurple}>
        ...
        <Accordion title="unit 03 - Getting ready to travel aboard" className={true} textColor={Colors.smartPurple}>
        ...
        <Accordion title="unit 04 - Getting ready to travel aboard" className={true} textColor={Colors.smartPurple}>
        ...
        <Accordion title="unit 05 - Getting ready to travel aboard" className={true} textColor={Colors.smartPurple}>
        ...
        <Accordion title="unit 06 - Getting ready to travel aboard" className={true} textColor={Colors.smartPurple}>
        ...
        <Accordion title="unit 07 - Getting ready to travel aboard" className={true} textColor={Colors.smartPurple}>
        ...
        <Accordion title="unit 08 - Getting ready to travel aboard" className={true} textColor={Colors.smartPurple}>
      ...
      <Accordion title="Accordion" color={Colors.smartYellow} textColor={Colors.smartPurple}>
